...
class Comment {
    ...
    public function wasLikedBy() {
        ...
        $query = $this->con->prepare("SELECT * FROM likes WHERE username=:un AND commentId=:commentId");
    ...
    public function wasDislikedBy() {
        ...
        $query = $this->con->prepare("SELECT * FROM dislikes WHERE username=:un AND commentId=:commentId");
    ...
    public function like() {
        ...
        if($this->wasLikedBy()) {
            ...
            $query = $this->con->prepare("INSERT INTO likes (username, commentId) VALUE(:username, :commentId)");
    ...
    public function dislike() {
        ...
        if($this->wasDislikedBy()) {
            ...
            $query = $this->con->prepare("INSERT INTO dislikes (username, commentId) VALUE(:username, :commentId)");
            $query->bindParam(":username", $username);
            $query->bindParam(":commentId", $id);
            $query->execute();
